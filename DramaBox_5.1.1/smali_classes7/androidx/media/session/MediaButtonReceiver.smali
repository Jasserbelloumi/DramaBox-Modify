...
.method public static buildMediaButtonPendingIntent(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
    ...
    .line 6
    :cond_0
    invoke-static {p2, p3}, Landroid/support/v4/media/session/PlaybackStateCompat;->l(J)I
...
.method public static handleIntent(Landroid/support/v4/media/session/MediaSessionCompat;Landroid/content/Intent;)Landroid/view/KeyEvent;
    ...
    .line 33
    .line 34
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat;->dramaboxapp()Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    .line 37
    .line 38
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat;->dramabox(Landroid/view/KeyEvent;)Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 62
    .line 63
    invoke-direct {p2, p1, v0, v2, v1}, Landroid/support/v4/media/MediaBrowserCompat;-><init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$O;Landroid/os/Bundle;)V
    ...
    .line 68
    .line 69
    invoke-virtual {p2}, Landroid/support/v4/media/MediaBrowserCompat;->dramabox()V
