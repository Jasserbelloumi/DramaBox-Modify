.class public LR6/io$dramaboxapp;
...
.method public constructor <init>(LR6/io;Landroidx/room/RoomDatabase;)V
    ...
    .line 1
    .line 2
    iput-object p1, p0, LR6/io$dramaboxapp;->dramabox:LR6/io;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    .line 4
    .line 5
    invoke-virtual {p0, p1, p2}, LR6/io$dramaboxapp;->dramabox(Landroidx/sqlite/db/SupportSQLiteStatement;LS6/dramabox;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    .line 1
    .line 2
    const-string v0, "UPDATE OR ABORT `downloads` SET `id` = ?,`bookId` = ?,`bookName` = ?,`chapterImg` = ?,`chapterId` = ?,`chapterIndex` = ?,`isPay` = ?,`priority` = ?,`url` = ?,`quality` = ?,`path` = ?,`fileName` = ?,`tag` = ?,`headersJson` = ?,`timeQueued` = ?,`state` = ?,`totalBytes` = ?,`downloadedBytes` = ?,`speedInBytePerMs` = ?,`lastModified` = ?,`eTag` = ?,`fileMd5` = ?,`userOp` = ?,`extData` = ?,`failureReason` = ? WHERE `id` = ?"
