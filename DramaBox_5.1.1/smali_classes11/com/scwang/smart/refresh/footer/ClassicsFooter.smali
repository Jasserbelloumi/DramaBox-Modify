...
# static fields
.field public static Jui:Ljava/lang/String;

.field public static Jvf:Ljava/lang/String;

.field public static Ok1:Ljava/lang/String;

.field public static skn:Ljava/lang/String;

.field public static slo:Ljava/lang/String;

.field public static swe:Ljava/lang/String;

.field public static syp:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    iput-boolean v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jbn:Z
    ...
    iput-object v2, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->aew:Landroid/widget/ImageView;
    ...
    iput-object v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->l1:Landroid/widget/TextView;
    ...
    iget v4, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->opn:I

    invoke-virtual {p2, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    iput v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->opn:I

    .line 22
    sget-object v3, LO7/dramaboxapp;->ll:[LO7/dramaboxapp;

    sget v4, Lcom/scwang/smart/refresh/footer/classics/R$styleable;->ClassicsFooter_srlClassicsSpinnerStyle:I

    iget-object v5, p0, Lcom/scwang/smart/refresh/layout/simple/SimpleComponent;->l:LO7/dramaboxapp;

    iget v5, v5, LO7/dramaboxapp;->dramabox:I
    ...
    .line 25
    :cond_0
    iget-object v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->pos:Landroid/widget/ImageView;
    ...
    .line 26
    new-instance v3, LL7/dramabox;

    invoke-direct {v3}, LL7/dramabox;-><init>()V

    iput-object v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->pop:LK7/dramabox;

    .line 27
    invoke-virtual {v3, v5}, LK7/dramabox;->dramabox(I)V

    .line 28
    iget-object v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->pos:Landroid/widget/ImageView;

    iget-object v4, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->pop:LK7/dramabox;
    ...
    .line 31
    :cond_2
    iget-object v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->aew:Landroid/widget/ImageView;
    ...
    .line 32
    new-instance v3, LK7/dramaboxapp;

    invoke-direct {v3}, LK7/dramaboxapp;-><init>()V

    iput-object v3, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->lop:LK7/dramabox;
    ...
    iget-object v4, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->lop:LK7/dramabox;
    ...
    .line 36
    iget-object v4, p0, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->l1:Landroid/widget/TextView;

    const/high16 v5, 0x41800000    # 16.0f

    invoke-static {v5}, LR7/O;->O(F)I
    ...
    invoke-super {p0, v3}, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->jkk(I)Lcom/scwang/smart/refresh/classics/ClassicsAbstract;
    ...
    invoke-super {p0, v0}, Lcom/scwang/smart/refresh/classics/ClassicsAbstract;->lo(I)Lcom/scwang/smart/refresh/classics/ClassicsAbstract;
    ...
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->ysh:Ljava/lang/String;

    goto :goto_2

    .line 43
    :cond_7
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jvf:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->JKi:Ljava/lang/String;

    goto :goto_3

    .line 48
    :cond_9
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jui:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->JOp:Ljava/lang/String;

    goto :goto_4

    .line 53
    :cond_b
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Ok1:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jqq:Ljava/lang/String;

    goto :goto_5

    .line 58
    :cond_d
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->syp:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->O0l:Ljava/lang/String;

    goto :goto_6

    .line 63
    :cond_f
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->slo:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jkl:Ljava/lang/String;

    goto :goto_7

    .line 68
    :cond_11
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->skn:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jhg:Ljava/lang/String;

    goto :goto_8

    .line 73
    :cond_13
    sget-object v0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->swe:Ljava/lang/String;

    if-eqz v0, :cond_14

    .line 74
    iput-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jhg:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->JOp:Ljava/lang/String;

    goto :goto_9

    :cond_15
    iget-object p2, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->ysh:Ljava/lang/String;
...
.method public l(LN7/io;Z)I
    ...
    .line 4
    .line 5
    iget-boolean p1, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jbn:Z
    ...
    .line 12
    .line 13
    iget-object p2, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->O0l:Ljava/lang/String;
    ...
    .line 16
    :cond_0
    iget-object p2, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jkl:Ljava/lang/String;
...
.method public pos(LN7/io;Lcom/scwang/smart/refresh/layout/constant/RefreshState;Lcom/scwang/smart/refresh/layout/constant/RefreshState;)V
    ...
    .line 3
    .line 4
    iget-boolean p2, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jbn:Z
    ...
    .line 7
    .line 8
    sget-object p2, Lcom/scwang/smart/refresh/footer/ClassicsFooter$dramabox;->dramabox:[I
    ...
    .line 23
    .line 24
    iget-object v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jqq:Ljava/lang/String;
    ...
    .line 34
    .line 35
    iget-object p3, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->JKi:Ljava/lang/String;
    ...
    .line 65
    .line 66
    iget-object p3, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->ysh:Ljava/lang/String;
...
.method public setNoMoreData(Z)Z
    ...
    .line 1
    .line 2
    iget-boolean v0, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jbn:Z
    ...
    .line 5
    .line 6
    iput-boolean p1, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jbn:Z
    ...
    .line 13
    .line 14
    iget-object v1, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->Jhg:Ljava/lang/String;
    ...
    .line 26
    .line 27
    iget-object v1, p0, Lcom/scwang/smart/refresh/footer/ClassicsFooter;->ysh:Ljava/lang/String;
