.class final Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;
...
.method static constructor <clinit>()V
    ...
    .line 1
    .line 2
    new-instance v0, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter$1;

    .line 3
    .line 4
    .line 5
    invoke-direct {v0}, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter$1;-><init>()V

    .line 6
    .line 7
    sput-object v0, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;->FACTORY:Lcom/sobot/gson/TypeAdapterFactory;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;->format:Ljava/text/DateFormat;

    return-void
.end method

.method public synthetic constructor <init>(Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter$1;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;-><init>()V
...
.method public bridge synthetic read(Lcom/sobot/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;->read(Lcom/sobot/gson/stream/JsonReader;)Ljava/sql/Date;
...
.method public read(Lcom/sobot/gson/stream/JsonReader;)Ljava/sql/Date;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 6
    :try_start_1
    iget-object v1, p0, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;->format:Ljava/text/DateFormat;
...
.method public bridge synthetic write(Lcom/sobot/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;->write(Lcom/sobot/gson/stream/JsonWriter;Ljava/sql/Date;)V

    return-void
.end method

.method public write(Lcom/sobot/gson/stream/JsonWriter;Ljava/sql/Date;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 4
    :try_start_0
    iget-object v0, p0, Lcom/sobot/gson/internal/sql/SqlDateTypeAdapter;->format:Ljava/text/DateFormat;
