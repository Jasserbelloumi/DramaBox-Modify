...
.method public static synthetic access$400(Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;LRc/dramaboxapp;Lcom/applovin/mediation/nativeAds/MaxNativeAd$MaxNativeAdImage;)V
    .locals 0

    .line 1
    .line 2
    .line 3
    invoke-direct {p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->handleNativeAdLoaded(LRc/dramaboxapp;Lcom/applovin/mediation/nativeAds/MaxNativeAd$MaxNativeAdImage;)V
...
.method private handleNativeAdLoaded(LRc/dramaboxapp;Lcom/applovin/mediation/nativeAds/MaxNativeAd$MaxNativeAdImage;)V
    .locals 1
    ...
    .line 4
    .line 5
    invoke-direct {v0, p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener$2;-><init>(Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;LRc/dramaboxapp;Lcom/applovin/mediation/nativeAds/MaxNativeAd$MaxNativeAdImage;)V
...
# virtual methods
.method public onAdClicked(LRc/dramaboxapp;)V
    .locals 1
...
.method public bridge synthetic onAdClicked(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->onAdClicked(LRc/dramaboxapp;)V

    return-void
.end method

.method public onAdExpired(LRc/dramaboxapp;)V
    .locals 1
...
.method public bridge synthetic onAdExpired(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->onAdExpired(LRc/dramaboxapp;)V

    return-void
.end method

.method public onAdImpression(LRc/dramaboxapp;)V
    .locals 1
...
.method public bridge synthetic onAdImpression(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->onAdImpression(LRc/dramaboxapp;)V

    return-void
.end method

.method public onAdLoadFailed(LRc/dramaboxapp;LLd/dramabox;)V
    .locals 2

    .line 2
    iget-object p1, p0, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->this$0:Lcom/applovin/mediation/adapters/BidMachineMediationAdapter;

    invoke-static {p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter;->access$200(Lcom/applovin/mediation/adapters/BidMachineMediationAdapter;LLd/dramabox;)Lcom/applovin/mediation/adapter/MaxAdapterError;
...
.method public bridge synthetic onAdLoadFailed(Lio/bidmachine/IAd;LLd/dramabox;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->onAdLoadFailed(LRc/dramaboxapp;LLd/dramabox;)V

    return-void
.end method

.method public onAdLoaded(LRc/dramaboxapp;)V
    .locals 4
    ...
    .line 5
    invoke-virtual {p1}, LRc/dramaboxapp;->lO()Ljava/lang/String;
    ...
    .line 8
    :cond_0
    invoke-virtual {p1}, LRc/dramaboxapp;->getIcon()Lio/bidmachine/ImageData;
    ...
    .line 9
    invoke-direct {p0, p1, v1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->handleNativeAdLoaded(LRc/dramaboxapp;Lcom/applovin/mediation/nativeAds/MaxNativeAd$MaxNativeAdImage;)V
    ...
    invoke-direct {v2, p0, v0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener$1;-><init>(Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;Ljava/lang/String;LRc/dramaboxapp;)V
...
.method public bridge synthetic onAdLoaded(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->onAdLoaded(LRc/dramaboxapp;)V

    return-void
.end method

.method public onAdShowFailed(LRc/dramaboxapp;LLd/dramabox;)V
    .locals 2
...
.method public bridge synthetic onAdShowFailed(Lio/bidmachine/IAd;LLd/dramabox;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$NativeAdListener;->onAdShowFailed(LRc/dramaboxapp;LLd/dramabox;)V
