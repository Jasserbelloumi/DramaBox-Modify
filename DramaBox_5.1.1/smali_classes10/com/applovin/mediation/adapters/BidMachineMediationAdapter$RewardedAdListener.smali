...
# virtual methods
.method public onAdClicked(LBd/dramabox;)V
    .locals 1
...
.method public bridge synthetic onAdClicked(Lio/bidmachine/IAd;)V
    ...
    .line 1
    check-cast p1, LBd/dramabox;

    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdClicked(LBd/dramabox;)V

    return-void
.end method

.method public onAdClosed(LBd/dramabox;Z)V
    .locals 2
...
.method public bridge synthetic onAdClosed(Lio/bidmachine/IAd;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdClosed(LBd/dramabox;Z)V

    return-void
.end method

.method public onAdExpired(LBd/dramabox;)V
    .locals 1
...
.method public bridge synthetic onAdExpired(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdExpired(LBd/dramabox;)V

    return-void
.end method

.method public onAdImpression(LBd/dramabox;)V
    .locals 1
...
.method public bridge synthetic onAdImpression(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdImpression(LBd/dramabox;)V

    return-void
.end method

.method public onAdLoadFailed(LBd/dramabox;LLd/dramabox;)V
    .locals 2
...
.method public bridge synthetic onAdLoadFailed(Lio/bidmachine/IAd;LLd/dramabox;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdLoadFailed(LBd/dramabox;LLd/dramabox;)V

    return-void
.end method

.method public onAdLoaded(LBd/dramabox;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lio/bidmachine/BidMachineAd;->getAuctionResult()LQc/O;

    move-result-object p1

    invoke-static {v0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter;->access$100(Lcom/applovin/mediation/adapters/BidMachineMediationAdapter;LQc/O;)Ljava/lang/String;
...
.method public bridge synthetic onAdLoaded(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdLoaded(LBd/dramabox;)V

    return-void
.end method

.method public onAdRewarded(LBd/dramabox;)V
    .locals 1
...
.method public bridge synthetic onAdRewarded(Lio/bidmachine/IAd;)V
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdRewarded(LBd/dramabox;)V

    return-void
.end method

.method public onAdShowFailed(LBd/dramabox;LLd/dramabox;)V
    .locals 2
    ...
    .line 3
    invoke-virtual {p2}, LLd/dramabox;->I()I

    move-result v1

    .line 4
    invoke-virtual {p2}, LLd/dramabox;->l1()Ljava/lang/String;
...
.method public bridge synthetic onAdShowFailed(Lio/bidmachine/IAd;LLd/dramabox;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/applovin/mediation/adapters/BidMachineMediationAdapter$RewardedAdListener;->onAdShowFailed(LBd/dramabox;LLd/dramabox;)V
