...
# direct methods
.method public constructor <init>(Lhg/O;JJLjava/util/concurrent/TimeUnit;LGe/jkk;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    .line 12
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lhg/O;
    ...
    .line 19
    .line 20
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:LGe/jkk;
    ...
    .line 24
    .line 25
    invoke-direct {p1, p8}, LWe/dramabox;-><init>(I)V

    .line 26
    .line 27
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:LWe/dramabox;
...
.method public cancel()V
    ...
    .line 8
    .line 9
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lhg/l;
    ...
    .line 19
    .line 20
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:LWe/dramabox;
...
.method public checkTerminated(ZLhg/O;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 6
    .line 7
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:LWe/dramabox;
    ...
    .line 21
    .line 22
    invoke-interface {p2, p1}, Lhg/O;->onError(Ljava/lang/Throwable;)V
    ...
    .line 38
    .line 39
    invoke-interface {p2, p3}, Lhg/O;->onError(Ljava/lang/Throwable;)V
...
.method public drain()V
    ...
    .line 9
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lhg/O;

    .line 10
    .line 11
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:LWe/dramabox;
    ...
    .line 25
    .line 26
    invoke-virtual {p0, v5, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLhg/O;Z)Z
    ...
    .line 42
    :goto_0
    invoke-virtual {v1}, LWe/dramabox;->peek()Ljava/lang/Object;
    ...
    .line 51
    :goto_1
    invoke-virtual {p0, v11, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLhg/O;Z)Z
    ...
    .line 67
    .line 68
    invoke-static {v5, v9, v10}, LZe/dramaboxapp;->I(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    .line 78
    .line 79
    invoke-interface {v0, v11}, Lhg/O;->onNext(Ljava/lang/Object;)V
...
.method public onComplete()V
    ...
    .line 1
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:LGe/jkk;
    ...
    .line 9
    .line 10
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:LWe/dramabox;

    .line 11
    .line 12
    .line 13
    invoke-virtual {p0, v0, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLWe/dramabox;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 3
    .line 4
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:LGe/jkk;
    ...
    .line 16
    .line 17
    invoke-virtual {v0, v3, p1}, LWe/dramabox;->OT(Ljava/lang/Object;Ljava/lang/Object;)Z

    .line 18
    .line 19
    .line 20
    invoke-virtual {p0, v1, v2, v0}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLWe/dramabox;)V
...
.method public onSubscribe(Lhg/l;)V
    ...
    .line 9
    .line 10
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lhg/l;
...
.method public trim(JLWe/dramabox;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 20
    :goto_0
    invoke-virtual {p3}, LWe/dramabox;->isEmpty()Z
    ...
    .line 25
    .line 26
    invoke-virtual {p3}, LWe/dramabox;->peek()Ljava/lang/Object;
    ...
    .line 43
    .line 44
    invoke-virtual {p3}, LWe/dramabox;->ppo()I
    ...
    .line 54
    :cond_1
    invoke-virtual {p3}, LWe/dramabox;->poll()Ljava/lang/Object;
