...
.method public static synthetic dramabox(Landroidx/core/util/Consumer;Landroid/location/Location;)V
    .locals 0
...
.method public static synthetic dramaboxapp(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;)Ljava/lang/Boolean;
    .locals 0
...
.method public static getCurrentLocation(Landroid/location/LocationManager;Ljava/lang/String;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    .line 8
    new-instance p0, Lfor/aew;

    invoke-direct {p0, p4, v0}, Lfor/aew;-><init>(Landroidx/core/util/Consumer;Landroid/location/Location;)V
    ...
    .line 12
    new-instance p0, Landroidx/core/location/dramabox;

    invoke-direct {p0, v0}, Landroidx/core/location/dramabox;-><init>(Landroidx/core/location/LocationManagerCompat$CancellableLocationListener;)V
...
.method private static registerGnssMeasurementsCallbackOnR(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    ...
    .line 57
    .line 58
    invoke-static {}, Lfor/pos;->dramabox()Ljava/lang/Class;
...
.method private static registerGnssStatusCallback(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    new-instance v4, Landroidx/core/location/dramaboxapp;

    invoke-direct {v4, p0, v3}, Landroidx/core/location/dramaboxapp;-><init>(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;)V
...
.method public static unregisterGnssMeasurementsCallback(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    ...
    .line 19
    .line 20
    invoke-static {p1}, Lfor/ppo;->dramabox(Ljava/lang/Object;)Landroid/location/GnssMeasurementsEvent$Callback;
