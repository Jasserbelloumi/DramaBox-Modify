...
# instance fields
.field public final I:Lio/reactivex/BackpressureStrategy;

.field public final l:LGe/l1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LGe/l1<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(LGe/l1;Lio/reactivex/BackpressureStrategy;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate;->l:LGe/l1;

    .line 6
    .line 7
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate;->I:Lio/reactivex/BackpressureStrategy;
...
.method public ppo(Lhg/O;)V
    ...
    .line 1
    .line 2
    sget-object v0, Lio/reactivex/internal/operators/flowable/FlowableCreate$dramabox;->dramabox:[I

    .line 3
    .line 4
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate;->I:Lio/reactivex/BackpressureStrategy;
    ...
    .line 30
    .line 31
    invoke-direct {v0, p1, v1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$BufferAsyncEmitter;-><init>(Lhg/O;I)V
    ...
    .line 36
    .line 37
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$LatestAsyncEmitter;-><init>(Lhg/O;)V
    ...
    .line 42
    .line 43
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$DropAsyncEmitter;-><init>(Lhg/O;)V
    ...
    .line 48
    .line 49
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$ErrorAsyncEmitter;-><init>(Lhg/O;)V
    ...
    .line 54
    .line 55
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableCreate$MissingEmitter;-><init>(Lhg/O;)V
    ...
    .line 60
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCreate;->l:LGe/l1;

    .line 61
    .line 62
    .line 63
    invoke-interface {p1, v0}, LGe/l1;->subscribe(LGe/io;)V
    :try_end_0
