...
.method public static synthetic dramabox(Lio/bidmachine/AdRequest;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic dramaboxapp(Lio/bidmachine/AdRequest;)Ljava/lang/String;
    .locals 0
...
.method public static fetch(Lio/bidmachine/AdRequest;)Ljava/util/Map;
    ...
    .line 3
    .line 4
    new-instance v1, LXa/while;

    .line 5
    .line 6
    .line 7
    invoke-direct {v1, p0}, LXa/while;-><init>(Lio/bidmachine/AdRequest;)V
    ...
    .line 35
    .line 36
    new-instance v3, Lio/bidmachine/BidMachineFetcher$dramabox;

    .line 37
    .line 38
    .line 39
    invoke-direct {v3}, Lio/bidmachine/BidMachineFetcher$dramabox;-><init>()V
...
.method public static identifyAdType(Lio/bidmachine/CreativeFormat;)Ljava/lang/String;
    ...
    .line 6
    :cond_0
    sget-object v1, Lio/bidmachine/BidMachineFetcher$dramaboxapp;->dramabox:[I
...
.method public static release(Lio/bidmachine/AdRequest;)Lio/bidmachine/AdRequest;
    ...
    .line 1
    invoke-virtual {p0}, Lio/bidmachine/AdRequest;->getAuctionResult()LQc/O;
    ...
    invoke-interface {v0}, LQc/O;->getId()Ljava/lang/String;
...
.method public static release(Lio/bidmachine/AdsType;Ljava/lang/String;)Lio/bidmachine/AdRequest;
    ...
    new-instance v2, LXa/import;

    invoke-direct {v2, p1}, LXa/import;-><init>(Ljava/lang/String;)V
...
.method public static toMap(Lio/bidmachine/AdRequest;)Ljava/util/Map;
    ...
    .line 1
    .line 2
    new-instance v0, LXa/native;

    .line 3
    .line 4
    .line 5
    invoke-direct {v0, p0}, LXa/native;-><init>(Lio/bidmachine/AdRequest;)V
    ...
    .line 26
    .line 27
    invoke-interface {p0}, LQc/O;->getId()Ljava/lang/String;
    ...
    .line 33
    .line 34
    invoke-interface {p0}, LQc/O;->getPrice()D
    ...
    .line 48
    .line 49
    invoke-interface {p0}, LQc/O;->dramabox()Ljava/lang/String;
    ...
    .line 55
    .line 56
    invoke-interface {p0}, LQc/O;->O()Lio/bidmachine/CreativeFormat;
    ...
    .line 71
    :cond_1
    invoke-interface {p0}, LQc/O;->getCustomParams()Ljava/util/Map;
