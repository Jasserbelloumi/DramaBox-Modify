...
.method public static getForceDark(Landroid/webkit/WebSettings;)I
    ...
    .line 2
    .line 3
    invoke-static {p0}, Lsynchronized/skn;->dramabox(Landroid/webkit/WebSettings;)I
...
.method public static getWebViewRenderProcess(Landroid/webkit/WebView;)Landroid/webkit/WebViewRenderProcess;
    ...
    .line 2
    .line 3
    invoke-static {p0}, Lsynchronized/Jui;->dramabox(Landroid/webkit/WebView;)Landroid/webkit/WebViewRenderProcess;
...
.method public static getWebViewRenderProcessClient(Landroid/webkit/WebView;)Landroid/webkit/WebViewRenderProcessClient;
    ...
    .line 2
    .line 3
    invoke-static {p0}, Lsynchronized/Ok1;->dramabox(Landroid/webkit/WebView;)Landroid/webkit/WebViewRenderProcessClient;
...
.method public static setForceDark(Landroid/webkit/WebSettings;I)V
    ...
    .line 2
    .line 3
    invoke-static {p0, p1}, Lsynchronized/swe;->dramabox(Landroid/webkit/WebSettings;I)V
...
.method public static setWebViewRenderProcessClient(Landroid/webkit/WebView;Landroidx/webkit/WebViewRenderProcessClient;)V
    ...
    .line 4
    :goto_0
    invoke-static {p0, v0}, Lsynchronized/syp;->dramabox(Landroid/webkit/WebView;Landroid/webkit/WebViewRenderProcessClient;)V
...
.method public static setWebViewRenderProcessClient(Landroid/webkit/WebView;Ljava/util/concurrent/Executor;Landroidx/webkit/WebViewRenderProcessClient;)V
    ...
    .line 2
    :goto_0
    invoke-static {p0, p1, v0}, Lsynchronized/swr;->dramabox(Landroid/webkit/WebView;Ljava/util/concurrent/Executor;Landroid/webkit/WebViewRenderProcessClient;)V
...
.method public static terminate(Landroid/webkit/WebViewRenderProcess;)Z
    ...
    .line 2
    .line 3
    invoke-static {p0}, Lsynchronized/slo;->dramabox(Landroid/webkit/WebViewRenderProcess;)Z
