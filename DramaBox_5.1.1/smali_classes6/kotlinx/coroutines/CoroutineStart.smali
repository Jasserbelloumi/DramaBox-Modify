...
# virtual methods
.method public final invoke(Lkotlin/jvm/functions/Function1;Lof/O;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 3
    :cond_1
    invoke-static {p1, p2}, Lkotlinx/coroutines/intrinsics/UndispatchedKt;->startCoroutineUndispatched(Lkotlin/jvm/functions/Function1;Lof/O;)V

    goto :goto_0

    .line 4
    :cond_2
    invoke-static {p1, p2}, Lof/l;->dramaboxapp(Lkotlin/jvm/functions/Function1;Lof/O;)V

    goto :goto_0

    .line 5
    :cond_3
    invoke-static {p1, p2}, Lkotlinx/coroutines/intrinsics/CancellableKt;->startCoroutineCancellable(Lkotlin/jvm/functions/Function1;Lof/O;)V

    :goto_0
    return-void
.end method

.method public final invoke(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lof/O;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 8
    :cond_1
    invoke-static {p1, p2, p3}, Lkotlinx/coroutines/intrinsics/UndispatchedKt;->startCoroutineUndispatched(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lof/O;)V

    goto :goto_0

    .line 9
    :cond_2
    invoke-static {p1, p2, p3}, Lof/l;->O(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lof/O;)V
    ...
    .line 10
    invoke-static/range {v0 .. v5}, Lkotlinx/coroutines/intrinsics/CancellableKt;->startCoroutineCancellable$default(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lof/O;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)V
