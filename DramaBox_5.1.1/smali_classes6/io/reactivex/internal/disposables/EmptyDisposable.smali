...
.method public static complete(LGe/aew;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, LGe/aew;->onSubscribe(LJe/dramaboxapp;)V
...
.method public static complete(LGe/dramaboxapp;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, LGe/dramaboxapp;->onSubscribe(LJe/dramaboxapp;)V

    .line 6
    invoke-interface {p0}, LGe/dramaboxapp;->onComplete()V

    return-void
.end method

.method public static complete(LGe/lo;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, LGe/lo;->onSubscribe(LJe/dramaboxapp;)V

    .line 4
    invoke-interface {p0}, LGe/lo;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;LGe/aew;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;LGe/dramaboxapp;)V
    .locals 1
    ...
    .line 4
    invoke-interface {p1, p0}, LGe/dramaboxapp;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;LGe/lo;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-interface {p1, p0}, LGe/lo;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;LGe/lop;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p1, p0}, LGe/lop;->onError(Ljava/lang/Throwable;)V
