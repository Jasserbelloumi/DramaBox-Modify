...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$dramaboxapp;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    .line 1
    .line 2
    new-instance v0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$dramabox;

    .line 3
    .line 4
    .line 5
    invoke-direct {v0}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$dramabox;-><init>()V
...
.method public constructor <init>(Landroid/media/session/MediaSession$QueueItem;Landroid/support/v4/media/MediaDescriptionCompat;J)V
    ...
    .line 4
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->I:Landroid/media/session/MediaSession$QueueItem;
...
.method public static O(Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;
    .locals 4
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$dramaboxapp;->dramaboxapp(Landroid/media/session/MediaSession$QueueItem;)Landroid/media/MediaDescription;
    ...
    .line 14
    .line 15
    invoke-static {p0}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$dramaboxapp;->O(Landroid/media/session/MediaSession$QueueItem;)J
...
.method public static l(Ljava/util/List;)Ljava/util/List;
    ...
    .line 27
    .line 28
    invoke-static {v1}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->O(Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;
