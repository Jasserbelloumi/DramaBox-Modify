...
# instance fields
.field private final mCallback:LO/dramabox;
...
.field private final mService:LO/dramaboxapp;


# direct methods
.method public constructor <init>(LO/dramaboxapp;LO/dramabox;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    .locals 1
    ...
    .line 11
    .line 12
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LO/dramaboxapp;

    .line 13
    .line 14
    iput-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)LO/O$dramabox;
    .locals 1
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)LO/O$dramabox;
    .locals 1
...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    .line 15
    .line 16
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(LO/dramaboxapp;LO/dramabox;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public getBinder()Landroid/os/IBinder;
    ...
    .line 1
    .line 2
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;
...
.method public isEngagementSignalsApiAvailable(Landroid/os/Bundle;)Z
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LO/dramaboxapp;

    .line 7
    .line 8
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;

    .line 9
    .line 10
    .line 11
    invoke-interface {v0, v1, p1}, LO/dramaboxapp;->isEngagementSignalsApiAvailable(LO/dramabox;Landroid/os/Bundle;)Z
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 10
    .line 11
    invoke-interface {v0, v1, p1, p2, p3}, LO/dramaboxapp;->mayLaunchUrl(LO/dramabox;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public postMessage(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 9
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LO/dramaboxapp;

    .line 10
    .line 11
    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;

    .line 12
    .line 13
    .line 14
    invoke-interface {v1, v2, p1, p2}, LO/dramaboxapp;->postMessage(LO/dramabox;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public receiveFile(Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    .line 10
    .line 11
    invoke-interface {v0, v1, p1, p2, p3}, LO/dramaboxapp;->receiveFile(LO/dramabox;Landroid/net/Uri;ILandroid/os/Bundle;)Z
...
.method public requestPostMessageChannel(Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 4
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LO/dramaboxapp;

    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;

    invoke-interface {p2, v0, p1, p3}, LO/dramaboxapp;->requestPostMessageChannelWithExtras(LO/dramabox;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;

    invoke-interface {p2, p3, p1}, LO/dramaboxapp;->requestPostMessageChannel(LO/dramabox;Landroid/net/Uri;)Z
...
.method public setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 34
    .line 35
    invoke-interface {p2, v0, p1}, LO/dramaboxapp;->updateVisuals(LO/dramabox;Landroid/os/Bundle;)Z
...
.method public setEngagementSignalsCallback(Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 2
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)LO/O$dramabox;
    ...
    invoke-interface {v0, v1, p1, p2}, LO/dramaboxapp;->setEngagementSignalsCallback(LO/dramabox;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public setEngagementSignalsCallback(Ljava/util/concurrent/Executor;Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 6
    invoke-direct {p0, p2, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)LO/O$dramabox;
    ...
    invoke-interface {p2, v0, p1, p3}, LO/dramaboxapp;->setEngagementSignalsCallback(LO/dramabox;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarSwipeUpGesture(Landroid/app/PendingIntent;)Z
    ...
    .line 15
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:LO/dramaboxapp;
    ...
    .line 19
    .line 20
    invoke-interface {p1, v1, v0}, LO/dramaboxapp;->updateVisuals(LO/dramabox;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    .line 26
    .line 27
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:LO/dramabox;

    .line 28
    .line 29
    .line 30
    invoke-interface {p1, p2, v0}, LO/dramaboxapp;->updateVisuals(LO/dramabox;Landroid/os/Bundle;)Z
...
.method public setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 39
    .line 40
    invoke-interface {p2, p3, p1}, LO/dramaboxapp;->updateVisuals(LO/dramabox;Landroid/os/Bundle;)Z
...
.method public validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 18
    .line 19
    invoke-interface {v0, v2, p1, p2, p3}, LO/dramaboxapp;->validateRelationship(LO/dramabox;ILandroid/net/Uri;Landroid/os/Bundle;)Z
