...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
    ...
    .line 40
    invoke-static {p2}, LLkL/tyu;->dramabox(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
    ...
    .line 41
    invoke-static {p2}, LLkL/yu0;->dramabox(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
    ...
    .line 42
    invoke-static {p2}, LLkL/opn;->dramabox(Landroid/content/pm/ShortcutInfo;)[Landroid/content/Intent;
    ...
    .line 44
    invoke-static {p2}, LLkL/lks;->dramabox(Landroid/content/pm/ShortcutInfo;)Landroid/content/ComponentName;
    ...
    .line 45
    invoke-static {p2}, LLkL/ygn;->dramabox(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    .line 46
    invoke-static {p2}, LLkL/djd;->dramabox(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    .line 47
    invoke-static {p2}, LLkL/yhj;->dramabox(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    .line 49
    invoke-static {p2}, LLkL/ygh;->dramabox(Landroid/content/pm/ShortcutInfo;)I
    ...
    .line 50
    :cond_0
    invoke-static {p2}, LLkL/Jbn;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 52
    :goto_1
    invoke-static {p2}, LLkL/yiu;->dramabox(Landroid/content/pm/ShortcutInfo;)Ljava/util/Set;
    ...
    .line 53
    invoke-static {p2}, LLkL/lO;->dramabox(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
    ...
    .line 54
    invoke-static {p2}, LLkL/ysh;->dramabox(Landroid/content/pm/ShortcutInfo;)Landroid/os/UserHandle;
    ...
    .line 55
    invoke-static {p2}, LLkL/JKi;->dramabox(Landroid/content/pm/ShortcutInfo;)J
    ...
    .line 56
    invoke-static {p2}, LLkL/JOp;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 57
    :cond_2
    invoke-static {p2}, LLkL/Jqq;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 58
    invoke-static {p2}, LLkL/O0l;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 59
    invoke-static {p2}, LLkL/Jkl;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 60
    invoke-static {p2}, LLkL/Jhg;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 62
    invoke-static {p2}, LLkL/Jvf;->dramabox(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 64
    invoke-static {p2}, LLkL/yyy;->dramabox(Landroid/content/pm/ShortcutInfo;)I
