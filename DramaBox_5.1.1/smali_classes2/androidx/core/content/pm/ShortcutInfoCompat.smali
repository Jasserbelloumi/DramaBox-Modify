...
.method public static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    .line 25
    .line 26
    invoke-static {v1}, LLkL/io;->dramabox(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getLocusId(Landroid/content/pm/ShortcutInfo;)Landroidx/core/content/LocusIdCompat;
    ...
    .line 3
    invoke-static {p0}, LLkL/l1;->dramabox(Landroid/content/pm/ShortcutInfo;)Landroid/content/LocusId;
    ...
    .line 5
    :cond_1
    invoke-static {p0}, LLkL/lO;->dramabox(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    .line 9
    .line 10
    invoke-static {v0, v1}, LLkL/ll;->dramabox(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 15
    .line 16
    invoke-static {v0, v1}, LLkL/dramaboxapp;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 21
    .line 22
    invoke-static {v0, v1}, LLkL/pos;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 35
    .line 36
    invoke-static {v0, v1}, LLkL/aew;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 48
    .line 49
    invoke-static {v0, v1}, LLkL/jkk;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 61
    .line 62
    invoke-static {v0, v1}, LLkL/pop;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 68
    .line 69
    invoke-static {v0, v1}, LLkL/lop;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 75
    .line 76
    invoke-static {v0, v1}, LLkL/O;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 80
    .line 81
    invoke-static {v0, v1}, LLkL/l;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;I)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 87
    .line 88
    invoke-static {v0, v1}, LLkL/RT;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 123
    :cond_6
    invoke-static {v0, v2}, LLkL/I;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 133
    .line 134
    invoke-static {v0, v1}, LLkL/IO;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 138
    .line 139
    invoke-static {v0, v1}, LLkL/OT;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;Z)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 161
    :cond_a
    invoke-static {v0}, LLkL/ppo;->dramabox(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
